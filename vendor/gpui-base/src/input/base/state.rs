...
pub struct InputBaseState<M: InputModeKind> {
    ...
    pub(super) grow_to_content: bool,
...
impl<M: InputModeKind> InputBaseState<M> {
    ...
    /// Measure the full wrapped content instead of allocating a scrolling viewport.
    pub fn grow_to_content(mut self, enabled: bool) -> Self {
        self.grow_to_content = enabled;
        self
    }
...
impl<M: InputModeKind> Render for InputBaseState<M> {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let element = div()
            ...
            .flex_1()
            .when(self.is_multi_line() && !self.grow_to_content, |this| {
                this.h_full()
            })
            .flex_grow_1()
            .when(self.grow_to_content, |this| this.flex_none().h_auto())
            .overflow_x_hidden()
            .when(self.is_multi_line(), |this| {
