...
[Download for macOS (Apple Silicon)](https://github.com/Envl/paperoll/releases/latest/download/Paperoll-0.2.4-macos-aarch64.dmg) · [macOS (Intel)](https://github.com/Envl/paperoll/releases/latest/download/Paperoll-0.2.4-macos-x86_64.dmg) · [Windows](https://github.com/Envl/paperoll/releases/latest/download/Paperoll-0.2.4-windows-x86_64-setup.exe) · [Linux](https://github.com/Envl/paperoll/releases/latest/download/Paperoll-0.2.4-linux-x86_64.AppImage)
